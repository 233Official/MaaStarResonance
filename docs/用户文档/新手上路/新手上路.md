...
**.NET 8 是微软的 .NET 平台的一个主要版本**，它提供了**C# 程序（以及 F#、VB.NET）运行所需的环境和基础库**。就像 C++ 需要 VCRedist 一样，C# 应用需要 .NET 运行时（Runtime）才能运行。

所有使用 MFAAvalonia 的用户都需要自行下载并安装适用于您系统的 .NET 8 。

Windows x64 .NET8 下载直链: [aspnetcore-runtime-8.0.21-win-x64.exe](https://builds.dotnet.microsoft.com/dotnet/aspnetcore/Runtime/8.0.21/aspnetcore-runtime-8.0.21-win-x64.exe)

> 微软官方 .NET 8 下载页面：
>  👉 <https://dotnet.microsoft.com/download/dotnet/8.0>
>
> ![image-20251102164211391](新手上路.assets/image-20251102164211391.png)
