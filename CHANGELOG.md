...
- 合并补充广告关闭 @233Official (Co-authored: azmiao)
- 新增两个 custom reco, 当所有/任一 reco节点识别成功时认为识别成功 @233Official (Co-authored: azmiao)
- 打开与识别补偿商店页面 @233Official (Co-authored: azmiao)
...
- 修复 Release Note 中作者链接错误的问题(#46) @233Official (Co-authored: azmiao)
- 修复 Release Note 无法处理多行标准 commit message 的问题(#48) @233Official (Co-authored: azmiao)
- 修复 utils 导入失败的问题 @233Official (Co-authored: azmiao)
...
- 优化初始化逻辑, 当 pyproject 没有变动时不再尝试安装依赖(#54) @233Official (Co-authored: azmiao)
- 优化 Release Info 解析(#48) @233Official (Co-authored: azmiao)
- 优化初始化时的日志打印, 添加 mfaa 规定前缀以支持在 mfaa 中显示 @233Official (Co-authored: azmiao)
- 优化自动钓鱼识别参数性能 @azmiao
- 将传送模块独立，优化传送检测，提取便于直接调用的方法 @azmiao

### 🎨 代码重构

- 延长默认超时时间，拆分等待登录检测和切换场景检测 @233Official (Co-authored: azmiao)
- 优化钓鱼环境检测逻辑，调整钓鱼参数 @233Official (Co-authored: azmiao)
- 根据 PR Review 规范化代码与配置 @233Official (Co-authored: azmiao)

### 🥚 格式化

- 规范化页面识别相关常量与工具类代码 @233Official (Co-authored: azmiao)
- 尝试修改日志格式 @azmiao
...
- v0.5.8 @233Official (Co-authored: azmiao)

### 🔧 配置文件

- Maafw更新至5.2.0 @233Official (Co-authored: azmiao)
- 固定 maafw 的版本为 5.2.0 @233Official (Co-authored: azmiao)
- 在 CI 中固定 MFAA 版本为 2.1.7 @233Official (Co-authored: azmiao)
- dependabot 不再跟踪 uv lock 更新, 转而跟踪 github actions 更新 @233Official (Co-authored: azmiao)
- 在CI 中固定 maafw 版本为 5.2.0 @233Official (Co-authored: azmiao)
- 升级MFAA到 v2.1.8 @233Official (Co-authored: azmiao)

### 🚧 进行中

- 页面识别 @233Official (Co-authored: azmiao)
...
- 新增回到主页面的节点以及函数装饰器 @233Official (Co-authored: Copilot)
- 新增退出省电模式的函数装饰器 @233Official (Co-authored: Copilot)
- 领取每日活跃度奖励 @233Official (Co-authored: Copilot)
...
- Code Format @233Official (Co-authored: Copilot)
...
- Android adb key event 新增 ESC 按键的值 @233Official (Co-authored: Copilot)
...
- 测试版自动钓鱼，图片和逻辑参考自 Particle_G ，感谢❤️ @azmiao (Co-authored: 233Official)
- 重构自动钓鱼逻辑和代码结构，支持部分参数配置 @azmiao (Co-authored: 233Official)

### 🐛 Bug修复

- 自动钓鱼异步改为同步，修复传参错误 @azmiao (Co-authored: 233Official)
- 修复设备输出控制器问题，调整游戏区服选项 @azmiao (Co-authored: 233Official)
- 修复钓鱼箭头判断出错 @azmiao (Co-authored: 233Official)
- 同步接入点新的节点 @azmiao (Co-authored: 233Official)
- 修复购买鱼饵失败问题 @azmiao (Co-authored: 233Official)
- 优化run_recognition回参适配MaaFW5.0+ @azmiao

### 🚀 性能优化

- 优化钓鱼逻辑 @azmiao (Co-authored: 233Official)
- 优化钓鱼性能，优化钓鱼逻辑，优化退出逻辑 @azmiao (Co-authored: 233Official)
- 优化收线结束检测逻辑 @azmiao (Co-authored: 233Official)
- 降低轮询间隔提高稳定性，尝试优化内存泄漏（无济于事 @azmiao (Co-authored: 233Official)
- 优化方向键转向冷却，修复鱼竿鱼饵选择接口 @azmiao (Co-authored: 233Official)
- 更新VSCODE推荐拓展 @azmiao
- 调整interface @azmiao

### 🥚 格式化

- 格式化代码 @azmiao (Co-authored: 233Official)
- 增加注释 @azmiao (Co-authored: 233Official)
...
- 添加建议扩展并配置basic pylance @azmiao (Co-authored: 233Official)
...
- 🔧build: 新增Win平台自适应分辨率的图标 @azmiao (Co-authored: Copilot)
...
- 新增Win平台绿毛图标可执行文件打包的支持，修改更可靠的矩阵式多平台编译方式，增强编译过程中的稳定性 @azmiao (Co-authored: Copilot)
- Remove unnecessary "）" @azmiao (Co-authored: Copilot)
