...
![image-20251119022910990](2.软件下载更新说明.assets/image-20251119022910990.png)

---

具体的更新设置在此处可以进行配置:

![image-20251119023100654](2.软件下载更新说明.assets/image-20251119023100654.png)
...
![image-20251119023216593](2.软件下载更新说明.assets/image-20251119023216593.png)
...
![image-20251119024215568](2.软件下载更新说明.assets/image-20251119024215568.png)

在左侧侧边栏找到 `Developer settings` 页面:

![image-20251119024322832](2.软件下载更新说明.assets/image-20251119024322832.png)

展开 `Personal access tokens` 选择 `Token(classic)`, 右上角选择 `Generate new token -> Generate new token(classic)`:

![image-20251119024515771](2.软件下载更新说明.assets/image-20251119024515771.png)

依次填写 `Note(key标识)`, 选择过期时间, 勾选下图中的权限复选框

![image-20251119024729975](2.软件下载更新说明.assets/image-20251119024729975.png)

最后点击 `Generate token` 创建 Classic token

![image-20251119024748016](2.软件下载更新说明.assets/image-20251119024748016.png)

然后复制这串 ghp 开头的 token 填写到 UI 对应配置输入框中即可:

![image-20251119024909601](2.软件下载更新说明.assets/image-20251119024909601.png)

![image-20251119024957413](2.软件下载更新说明.assets/image-20251119024957413.png)
...
![image-20251119025051225](2.软件下载更新说明.assets/image-20251119025051225.png)
...
2. 通过 GitHub 代理/镜像站点间接下载官方 Release
   ...
   ![image-20251119030316841](2.软件下载更新说明.assets/image-20251119030316841.png)

   ![image-20251119030346866](2.软件下载更新说明.assets/image-20251119030346866.png)

3. 通过 Mirror 酱下载软件压缩包

   访问 [Mirror酱/MAAStarResonance](https://mirrorchyan.com/zh/projects?rid=MaaStarResonance) 输入 CDK 然后点击下载即可

   ![image-20251119030640171](2.软件下载更新说明.assets/image-20251119030640171.png)
...
4. 通过 QQ 群文件下载
   ...
   ![image-20251119031004854](2.软件下载更新说明.assets/image-20251119031004854.png)
